...
class NetworkManager {
    ...
    func fetchCharacters(completion: @escaping (Result<PaginatedElements<Characters>, Error>) -> Void) {
        ...
        let task = session.dataTask(with: request) { (data, urlResponse, error) in
            ...
            do {
                ...
                let result = try jsonDecoder.decode(PaginatedElements<Characters>.self, from: data)
